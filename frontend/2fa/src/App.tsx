      ...
      <div className="flex min-h-svh min-w-svw items-center justify-center bg-zinc-950 p-6 text-white">
        <div className="w-full max-w-md rounded-2xl border border-zinc-800 bg-zinc-900 p-8 shadow-xl">
          ...
          <p className="mt-2 text-sm text-zinc-400">
            Please log in first. After the password check, you will need to complete
            the 2FA step.
          </p>
      ...
      <div className="min-h-svh min-w-svw bg-zinc-950 p-8 text-white">
        <div className="mx-auto max-w-5xl">
          ...
          <div className="mt-6 rounded-xl bg-zinc-900 p-4 text-sm text-zinc-400">
            The admin page is used to manage users and their keygen account status.
            If a keygen account is disabled, that user cannot continue to the 2FA
            verification step.
          </div>
        </div>
      </div>
